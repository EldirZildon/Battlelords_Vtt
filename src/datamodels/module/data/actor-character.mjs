...
export default class BattlelordsCharacter extends BattlelordsActorBase {
  ...
  static defineSchema() {
    ...
    schema.abilities = new fields.SchemaField(Object.keys(CONFIG.BATTLELORDS.abilities).reduce((obj, ability) => {
